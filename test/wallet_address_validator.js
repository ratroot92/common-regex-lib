...
describe('WAValidator.validate()', () => {
  describe('valid results', () => {
    ...
    it('should return true for correct monacoin addresses', () => {
    ...
    it('should return true for correct lsk addresses', () => {
  ...
  describe('invalid results', () => {
    ...
    it('should return false for incorrect monacoin addresses', () => {
      commonTests('mona');
    });
    ...
    it('should return false for incorrect lsk addresses', () => {
      commonTests('lsk');
