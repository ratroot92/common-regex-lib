...
const XLMValidator = require('./stellar_validator');
const EOSValidator = require('./eos_validator');
const XTZValidator = require('./tezos_validator');
const USDTValidator = require('./usdt_validator');
const AlgoValidator = require('./algo_validator');
const DotValidator = require('./dot_validator');
const BIP173Validator = require('./bip173_validator');
const Base58Validator = require('./base58_validator');
...
module.exports = {
  getByNameOrSymbol(currencyNameOrSymbol) {
    ...
    return CURRENCIES.find((currency) => currency.name.toLowerCase() === nameOrSymbol || currency.symbol.toLowerCase() === nameOrSymbol);
  },
  getAll() {
    return CURRENCIES;
  },
